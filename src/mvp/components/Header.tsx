...
const getViewTitle = (view: "today" | "logs" | "settings" | "trash" | TaskCategory, t: any) => {
...
const getViewDescription = (view: "today" | "logs" | "settings" | "trash" | TaskCategory, t: any) => {
...
const getViewIcon = (view: "today" | "logs" | "settings" | "trash" | TaskCategory) => {
