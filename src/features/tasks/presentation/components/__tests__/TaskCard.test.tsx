...
describe('TaskCard', () => {
  ...
  describe('Log Display', () => {
    ...
    it('should display last log preview', () => {
      ...
      expect(screen.getByText('This is the last log entry')).toBeInTheDocument();
    ...
    it('should show different icons for different log types', () => {
      ...
      const { rerender } = render(<TaskCard {...mockProps} lastLog={systemLog} />);
    ...
    it('should call onCreateLog when add log button is clicked', () => {
      ...
      render(<TaskCard {...mockProps} lastLog={lastLog} onCreateLog={onCreateLog} />);
  ...
  describe('Overdue State', () => {
    ...
    it('should apply overdue styling', () => {
      const { container } = render(<TaskCard {...mockProps} isOverdue={true} />);
  ...
  describe('Completed State', () => {
    it('should show revert button for completed tasks', () => {
      ...
      expect(screen.getByText('↩️ Revert')).toBeInTheDocument();
    });

    it('should apply completed styling', () => {
      const completedTask = createMockTask({ status: TaskStatus.COMPLETED });
      const { container } = render(<TaskCard {...mockProps} task={completedTask} />);
