...
import { createTaskViewModel, TaskViewModelDependencies } from '../view-models/TaskViewModel';
import { TodayView } from '../../../today/presentation/components/TodayView';
import { TodayViewModelDependencies } from '../../../today/presentation/view-models/TodayViewModel';

// Mock dependencies for demo purposes
const mockTaskDependencies: TaskViewModelDependencies = {
  taskRepository: {
    findAll: async () => [],
    findById: async () => null,
    findByCategory: async () => [],
    findByStatus: async () => [],
    findByCategoryAndStatus: async () => [],
  ...
  createTaskUseCase: {
    execute: async () => ({ success: true, data: { taskId: 'mock-id' } }),
  } as any,
  updateTaskUseCase: {
...
const mockTodayDependencies: TodayViewModelDependencies = {
...
const taskViewModel = createTaskViewModel(mockTaskDependencies);
...
export const TasksDemo: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {activeTab === 'today' ? (
        <TodayView 
          dependencies={mockTodayDependencies}
