...
vi.mock('../../view-models/StatsViewModel', () => ({
  ...
  formatPeriodLabel: vi.fn((period, date) => `${period} - ${date.toDateString()}`)
}));
...
describe('StatisticsView', () => {
  ...
  it('should render statistics view with data', () => {
    ...
    expect(screen.getByText('Track your productivity and task completion patterns')).toBeInTheDocument();
  });
  ...
  it('should display empty state when no data', () => {
    ...
    expect(screen.getByText('Complete some tasks to see your productivity statistics.')).toBeInTheDocument();
  });
