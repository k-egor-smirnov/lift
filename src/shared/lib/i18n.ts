    ...
    translation: {
      ...
      settings: {
        ...
        llm: {
          ...
          description: "Configure AI-powered log summarization",
          enabled: "Enable AI Summarization",
          enabledDescription: "Use AI to automatically summarize task logs",
          apiUrl: "API URL",
          apiUrlDescription: "OpenAI-compatible API endpoint URL",
          apiKey: "API Key",
          apiKeyDescription: "Your API key for the LLM service",
          model: "Model",
          modelDescription: "AI model to use for summarization",
      ...
      logs: {
        title: "Activity Logs",
        subtitle: "View all system and user activity",
        summarize: "Summarize",
        ...
        task: "Task",
        changedCategory: "Changed category from {{from}} to {{to}}",
        changedTitle: 'Changed title from "{{from}}" to "{{to}}"',
        conflictResolved: "Sync conflict resolved, winner: {{winner}}",
        filters: {
          all: "All",
          system: "System",
          user: "Manual",
  ...
  ru: {
    translation: {
      ...
      settings: {
        ...
        llm: {
          title: "ИИ Суммаризация",
          description: "Настройка суммаризации логов с помощью ИИ",
          enabled: "Включить ИИ суммаризацию",
          enabledDescription:
            "Использовать ИИ для автоматической суммаризации логов задач",
          apiUrl: "URL API",
          apiUrlDescription: "URL эндпоинта OpenAI-совместимого API",
          apiKey: "API ключ",
          apiKeyDescription: "Ваш API ключ для сервиса LLM",
          model: "Модель",
          modelDescription: "Модель ИИ для использования в суммаризации",
          advanced: "Расширенные настройки",
          maxTokens: "Макс. токенов",
          maxTokensDescription: "Максимальное количество токенов в ответе",
          temperature: "Температура",
          temperatureDescription:
            "Контролирует случайность (0.0 = детерминированный, 2.0 = очень случайный)",
      ...
      logs: {
        ...
        subtitle: "Просмотр всей системной и пользовательской активности",
        summarize: "Суммаризировать",
        summarizing: "Суммаризация...",
        summaryTitle: "Сводка активности",
        summaryError: "Не удалось создать сводку",
        noLogs: "Логи не найдены",
        loading: "Загрузка...",
        errorLoading: "Ошибка загрузки логов",
        loadMore: "Загрузить ещё",
        addManualLog: "Добавить заметку...",
        noLogsFound: "Логи не найдены",
        task: "Задача",
        changedCategory: "Изменена категория с {{from}} на {{to}}",
        changedTitle: 'Изменено название с "{{from}}" на "{{to}}"',
        conflictResolved:
          "Конфликт синхронизации разрешен, победитель: {{winner}}",
        filters: {
          all: "Все",
          system: "Системные",
          user: "Ручные",
