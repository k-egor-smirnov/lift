    ...
    translation: {
      ...
      settings: {
        ...
        sync: {
          ...
          description: "Manage sync connection and account",
          serverUrl: "Sync server URL",
          serverUrlPlaceholder: "https://relay.example.com",
          authTitle: "Server authentication",
          connected: "Connected to relay server",
          alwaysEnabled: "Always enabled while connected",
    ...
    translation: {
      ...
      settings: {
        ...
        sync: {
          ...
          description: "Управление подключением и авторизацией синхронизации",
          serverUrl: "Адрес сервера синхронизации",
          serverUrlPlaceholder: "https://relay.example.com",
          authTitle: "Авторизация на сервере",
          connected: "Подключено к relay серверу",
          alwaysEnabled: "Всегда включено при подключении",
