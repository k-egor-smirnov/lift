...
describe('GetTaskLogsUseCase', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(mockDatabase.taskLogs.toCollection).mockReturnValue(mockCollection);
  ...
  describe('execute', () => {
    ...
    it('should filter logs by task ID', async () => {
      ...
      const mockWhereResult = vi.mocked(mockDatabase.taskLogs.where).mockReturnValue({
